...
def self_check() -> None:
    ...
    assert array_sum([6, 7, 5, 2]) == 20
    assert array_max([52, 67]) == 67
    assert count_equal_pairs([7, 3, 7, 3]) == 2      
    assert binary_pow(2, 10, mod=10000) == pow(2, 10, 10000)   
